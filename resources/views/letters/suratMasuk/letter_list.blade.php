...
<body>
  <div class="jumbotron  mt-2" style="padding:0px;">
    <div class="container">
            ...
            <p class="lead">Home/ <a href="{{route('result.index')}}">DataSurat</a>/<a href="#">LihatDataSurat</a></p>
        </div>
    </div>
  <br>
    <div class="card">
      ...
      <div class="card">
        ...
        <div class="card-body">
         ...
         <!-- Tampilkan gambar jika attachment tidak kosong -->
         @if($letter->attachment)
         <img src="{{ asset('images/' . $letter->attachment) }}" alt="Attachment" style="max-width: 100px; max-height: 100px;">
     @endif
