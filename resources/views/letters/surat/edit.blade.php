...
<div class="jumbotron  mt-2" style="padding:0px;">
    <div class="container">
            ...
            <p class="lead">Home/ <a href="{{route('letter.index')}}">DataSurat</a>/<a href="#">EditSurat</a></p>
        </div>
    </div>
    <form action="{{route('letter.update', $letter ['id'])}}" method="post" class="card bg-light mt-5 p-5">
