...
<div class="jumbotron  mt-2" style="padding:0px;">
    <div class="container">
            ...
            @endif --}}
            <h3><b>Edit Data Surat</b></h3>
            {{-- <h3>Selamat Datang </h3> --}}
            <p class="lead">Home/ <a href="{{route('letter_type.index')}}">DataSurat</a>/<a href="#">EditSurat</a></p>
        </div>
    </div>
    <form action="{{route('letter_type.update', $letter_type ['id'])}}" method="post" class="card bg-light mt-5 p-5">
